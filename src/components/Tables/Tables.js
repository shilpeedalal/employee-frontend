                      ...
                      return (
                        <>
                          <tr className='tr_data'>
                            <td className='tr_data'><b>{index + 1 + (page - 1)*4}</b></td>
                            <td className='tr_data'>{element.fname +" "+ element.lname}</td>
                            <td className='tr_data'>{element.email}</td>
                            <td className='tr_data'>{element.gender == "Male" ? "M" : "F"}</td>
